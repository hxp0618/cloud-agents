...
Independent Vite + React console for Control Plane Admin API operations. It uses the generated Admin SDK for Deployment Targets, Environment Leases, and immutable Environment Profiles, and keeps the bearer token in memory.
