...
COPY cloud-agents-migrations-000024.tar /opt/cloud-agents/cloud-agents-migrations-000024.tar
RUN mkdir -p /opt/cloud-agents/migrations \
    && tar -xf /opt/cloud-agents/cloud-agents-migrations-000024.tar -C /opt/cloud-agents/migrations \
