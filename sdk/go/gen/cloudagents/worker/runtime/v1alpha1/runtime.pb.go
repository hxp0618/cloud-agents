...
// carries only the authenticated Worker session and its fencing boundary.
...
const file_contracts_worker_runtime_v1alpha1_runtime_proto_rawDesc = "" +
	"\n" +
	"/contracts/worker/runtime/v1alpha1/runtime.proto\x12#cloudagents.worker.runtime.v1alpha1\x1a&contracts/worker/v1alpha1/kernel.proto\"\xd8\x02\n" +
	...
	"generation\x12g\n" +
	"\x18expected_worker_identity\x18\x05 \x01(\v2-.cloudagents.worker.v1alpha1.WorkloadIdentityR\x16expectedWorkerIdentity\")\n" +
