...
func DecodeRemoteWorkerSandboxCommandJSON(data []byte) (RemoteWorkerSandboxCommand, error) {
	...
	if json.Unmarshal(data, &value) != nil || common.ValidateIdentifier(value.CommandID, "/commandId") != nil || value.Attempt < 1 || value.Attempt > 8 || value.Action != "sandbox.create" && value.Action != "sandbox.stop" && value.Action != "sandbox.rebuild" || common.ValidateIdentifier(value.OperationID, "/operationId") != nil || common.ValidateIdentifier(value.WorkspaceID, "/workspaceId") != nil || common.ValidateIdentifier(value.WorkspaceName, "/workspaceName") != nil || common.ValidateIdentifier(value.TargetID, "/targetId") != nil || common.ValidateIdentifier(value.SandboxID, "/sandboxId") != nil || value.SandboxGeneration < 1 || value.SandboxGeneration > 9007199254740991 || len(value.ImageURI) > 1024 || !runtimeImagePattern.MatchString(value.ImageURI) || value.CPUMillis < 100 || value.CPUMillis > 64000 || value.MemoryBytes < 134217728 || value.MemoryBytes > 1099511627776 || !digestPattern.MatchString(value.SpecDigest) || common.ValidateIdentifier(value.NetworkPolicyID, "/networkPolicyId") != nil || !validRemoteWorkerSandboxAllowedEgress(value.NetworkAllowedEgress) || common.ValidateDateTime(value.Deadline, "/deadline") != nil {
