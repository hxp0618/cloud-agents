...
export const PLATFORM_RELEASE_MIGRATIONS = "cloud-agents-migrations-000029.tar";
export const PLATFORM_RELEASE_DEPLOYMENT = "cloud-agents-deployment-000029.tar";
...
export function buildPlatformMigrationPackage(root: string): Uint8Array {
  const manifestPath = "services/control-plane/migrations/product/000029/manifest.json";
