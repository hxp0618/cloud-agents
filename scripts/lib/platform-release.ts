...
export const PLATFORM_RELEASE_MIGRATIONS = "cloud-agents-migrations-000037.tar";
export const PLATFORM_RELEASE_DEPLOYMENT = "cloud-agents-deployment-000037.tar";
...
export function buildPlatformMigrationPackage(root: string): Uint8Array {
	const manifestPath = "services/control-plane/migrations/product/000037/manifest.json";
  ...
  const paths = new Set<string>([
    "LICENSE",
    manifestPath,
		"services/control-plane/migrations/product/000037/schema-bundle.json",
  ]);
