...
export const PLATFORM_RELEASE_MIGRATIONS = "cloud-agents-migrations-000028.tar";
...
export function buildPlatformMigrationPackage(root: string): Uint8Array {
  const manifestPath = "services/control-plane/migrations/product/000028/manifest.json";
  ...
  const paths = new Set<string>([
    manifestPath,
    "services/control-plane/migrations/product/000028/schema-bundle.json",
  ]);
