...
function lockAuthority() {
  return {
    ...
    contractStandards: {
      formatVersion: "cloud-agents-contract-standards-profile/v3" as const,
      profile: lockArtifact("tools/contract-standards/profile-v3.json", "8"),
      predecessor: {
        ...lockArtifact("tools/contract-standards/profile-v2.json", "9"),
