...
const base = "services/control-plane/migrations/product/000056";
const sqlPath = "services/control-plane/migrations/000056_add_foundation_sandbox_lifecycle.sql";
...
const prior = json("services/control-plane/migrations/product/000055/manifest.json");
const catalog = json(prior.schema_bundle.migrations.at(-1).catalog_contract.path);
catalog.schema_head = "000056";
...
catalog.source_descriptors.push({
  ...
  statements: splitPostgresStatements(sql).map((s) => ({
    ...
    sha256: s.sha256,
    classification: classifyMigrationStatement(s, "000056"),
  })),
});
const additions: any[] = [];
for (const [name, arguments_] of [
  ["transition_foundation_sandbox_v1", ["text", "text", "bigint", "bigint", "text", "text", "text", "text", "text", "text", "text", "text"]],
  ["claim_foundation_sandbox_v2", ["text", "text", "text", "integer", "text", "text"]],
  [
    "settle_foundation_sandbox_v2",
    [
      "text",
      "text",
      "text",
...
const catalogArtifact = artifact(`${base}/catalog/schema-000055.json`, catalogBytes);
const schema = structuredClone(prior.schema_bundle);
schema.schema_head = "000056";
schema.migrations.push({
  ...structuredClone(schema.migrations.at(-1)),
  id: "000056",
  name: "add_foundation_sandbox_lifecycle",
  predecessor_id: "000055",
  schema_from: "000055",
  schema_to: "000056",
...
process.stdout.write(`product-000056 ${mode}: ${schemaDigest}\n`);
