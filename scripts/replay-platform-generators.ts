...
if (args.length !== 2 || args[0] !== "--run") {
  throw new Error("Usage: bun scripts/replay-platform-generators.ts --run <root>");
}
...
verifyAuthorityDigest(
  "runner",
  resolve(root, "scripts/replay-platform-generators.ts"),
...
if (
  requireEnvironment("CLOUD_AGENTS_GENERATOR_WRAPPER_POLICY") !== "VERSIONED_ISOLATION_WRAPPER_V1"
) {
