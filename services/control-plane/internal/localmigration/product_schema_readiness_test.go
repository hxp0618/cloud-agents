...
func TestCheckProductSchemaReadiness(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "current", row: readinessRow{count: 41, first: "000001", last: "000041", bundleDigest: current.schemaBundleDigest}},
		...
		{name: "ahead", row: readinessRow{count: 42, first: "000001", last: "000042", bundleDigest: current.schemaBundleDigest}, wantErr: true},
		{name: "wrong bundle", row: readinessRow{count: 41, first: "000001", last: "000041", bundleDigest: productRunnerBindingSelector("000040").schemaBundleDigest}, wantErr: true},
