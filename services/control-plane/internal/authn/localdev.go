...
const (
	...
	localAdminPermission = "audit.list leases.get leases.list memberships.create memberships.delete memberships.get memberships.list memberships.update operations.list organizations.create organizations.get organizations.list profiles.create profiles.get profiles.list projects.act projects.create projects.get projects.list role-bindings.bind role-bindings.delete role-bindings.get role-bindings.list roles.get roles.list targets.act targets.create targets.get targets.list tenants.get"
