...
const (
	...
	localPermission                      = "environment-profiles.list environment-quotas.get environments.create environments.delete environments.get memberships.create memberships.delete memberships.get memberships.list memberships.update organizations.create organizations.get organizations.list projects.act projects.create projects.get projects.list role-bindings.bind role-bindings.delete role-bindings.get role-bindings.list roles.get roles.list sandboxes.update tenants.get"
	localAdminPermission                 = "audit.list environments.create environments.delete environments.get leases.act leases.get leases.list memberships.create memberships.delete memberships.get memberships.list memberships.update network-policies.get network-policies.list network-policies.update operations.list organizations.create organizations.get organizations.list profiles.act profiles.create profiles.get profiles.list projects.act projects.create projects.get projects.list quotas.get quotas.update releases.create releases.list remote-worker-enrollments.act remote-worker-enrollments.create remote-worker-enrollments.get remote-worker-enrollments.list role-bindings.bind role-bindings.delete role-bindings.get role-bindings.list roles.get roles.list sandboxes.act sandboxes.get sandboxes.list snapshots.act snapshots.create snapshots.delete snapshots.get snapshots.list storage-policies.get storage-policies.list storage-policies.update targets.act targets.create targets.get targets.list tenants.get workers.list"
