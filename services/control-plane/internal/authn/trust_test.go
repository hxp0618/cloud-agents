...
func TestSnapshotCanonicalProjectionGoldenAndBounds(t *testing.T) {
	...
	if got, want := snapshot.digest, "sha256:c8bdcb26a0ca9d16acb6a9022c4395ab063648a9adc95a3046c481545f81cd54"; got != want {
