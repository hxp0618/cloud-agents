...
func TestProductionAuthzAuthorityCallGraphClosure(t *testing.T) {
	...
	want := []string{
		...
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.ListMaintenanceOperations:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.ListMaintenanceOperations:method.Bind",
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.ListMaintenanceOperations:package.VerifiedOperationBinder",
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.ListMaintenanceOperations:package.WithVerifiedOperation",
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.PreviewDeploymentTargetScheduling:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.PreviewDeploymentTargetScheduling:method.Bind",
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.PreviewDeploymentTargetScheduling:package.VerifiedOperationBinder",
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.PreviewDeploymentTargetScheduling:package.WithVerifiedOperation",
		...
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.TransitionDeploymentTargetScheduling:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.TransitionDeploymentTargetScheduling:method.Actor",
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.TransitionDeploymentTargetScheduling:method.Bind",
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.TransitionDeploymentTargetScheduling:package.VerifiedOperationBinder",
		"internal/store/postgres/deployment_target.go:DurableCoordinationService.TransitionDeploymentTargetScheduling:package.WithVerifiedOperation",
		...
		"internal/store/postgres/environment_profile.go:DurableCoordinationService.ListPublishedEnvironmentProfiles:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/environment_profile.go:DurableCoordinationService.ListPublishedEnvironmentProfiles:method.Bind",
		"internal/store/postgres/environment_profile.go:DurableCoordinationService.ListPublishedEnvironmentProfiles:package.VerifiedOperationBinder",
		"internal/store/postgres/environment_profile.go:DurableCoordinationService.ListPublishedEnvironmentProfiles:package.WithVerifiedOperation",
		...
		"internal/store/postgres/foundation_runtime_profile.go:DurableCoordinationService.withFoundationOperation:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/foundation_runtime_profile.go:DurableCoordinationService.withFoundationOperation:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/foundation_runtime_profile.go:DurableCoordinationService.withFoundationOperation:method.Actor",
		...
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.BeginAdminEnvironmentLeaseUpgrade:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.BeginAdminEnvironmentLeaseUpgrade:method.Actor",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.BeginAdminEnvironmentLeaseUpgrade:method.Bind",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.BeginAdminEnvironmentLeaseUpgrade:package.VerifiedOperationBinder",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.BeginAdminEnvironmentLeaseUpgrade:package.WithVerifiedOperation",
		...
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.CompleteAdminEnvironmentLeaseUpgrade:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.CompleteAdminEnvironmentLeaseUpgrade:method.Bind",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.CompleteAdminEnvironmentLeaseUpgrade:package.VerifiedOperationBinder",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.CompleteAdminEnvironmentLeaseUpgrade:package.WithVerifiedOperation",
		...
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.CreateUserEnvironment:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.CreateUserEnvironment:method.Bind",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.CreateUserEnvironment:package.VerifiedOperationBinder",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.CreateUserEnvironment:package.WithVerifiedOperation",
		...
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.GetUserEnvironment:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.GetUserEnvironment:method.Bind",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.GetUserEnvironment:package.VerifiedOperationBinder",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.GetUserEnvironment:package.WithVerifiedOperation",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.ListAdminWorkers:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.ListAdminWorkers:method.Bind",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.ListAdminWorkers:package.VerifiedOperationBinder",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.ListAdminWorkers:package.WithVerifiedOperation",
		...
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.PreviewAdminEnvironmentLeaseUpgrade:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.PreviewAdminEnvironmentLeaseUpgrade:method.Bind",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.PreviewAdminEnvironmentLeaseUpgrade:package.VerifiedOperationBinder",
		"internal/store/postgres/managed_host_environment_lease.go:DurableCoordinationService.PreviewAdminEnvironmentLeaseUpgrade:package.WithVerifiedOperation",
		...
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.GetProjectLeaseQuota:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.GetProjectLeaseQuota:method.Bind",
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.GetProjectLeaseQuota:package.VerifiedOperationBinder",
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.GetProjectLeaseQuota:package.WithVerifiedOperation",
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.ListProjectLeaseQuotaAuditEvents:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.ListProjectLeaseQuotaAuditEvents:method.Bind",
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.ListProjectLeaseQuotaAuditEvents:package.VerifiedOperationBinder",
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.ListProjectLeaseQuotaAuditEvents:package.WithVerifiedOperation",
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.SetProjectLeaseQuota:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.SetProjectLeaseQuota:method.Actor",
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.SetProjectLeaseQuota:method.Bind",
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.SetProjectLeaseQuota:package.VerifiedOperationBinder",
		"internal/store/postgres/project_lease_quota.go:DurableCoordinationService.SetProjectLeaseQuota:package.WithVerifiedOperation",
		...
		"internal/store/postgres/network_policy.go:DurableCoordinationService.GetNetworkPolicy:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.GetStoragePolicy:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.GetNetworkPolicy:method.Bind",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.GetStoragePolicy:method.Bind",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.GetNetworkPolicy:package.VerifiedOperationBinder",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.GetStoragePolicy:package.VerifiedOperationBinder",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.GetNetworkPolicy:package.WithVerifiedOperation",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.GetStoragePolicy:package.WithVerifiedOperation",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.ListNetworkPolicies:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.ListStoragePolicies:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.ListNetworkPolicies:method.Bind",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.ListStoragePolicies:method.Bind",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.ListNetworkPolicies:package.VerifiedOperationBinder",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.ListStoragePolicies:package.VerifiedOperationBinder",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.ListNetworkPolicies:package.WithVerifiedOperation",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.ListStoragePolicies:package.WithVerifiedOperation",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.ListNetworkPolicyAuditEvents:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.ListStoragePolicyAuditEvents:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.ListNetworkPolicyAuditEvents:method.Bind",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.ListStoragePolicyAuditEvents:method.Bind",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.ListNetworkPolicyAuditEvents:package.VerifiedOperationBinder",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.ListStoragePolicyAuditEvents:package.VerifiedOperationBinder",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.ListNetworkPolicyAuditEvents:package.WithVerifiedOperation",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.ListStoragePolicyAuditEvents:package.WithVerifiedOperation",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.SetNetworkPolicy:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.SetStoragePolicy:bridge.executeVerifiedRBACOperation",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.SetNetworkPolicy:method.Actor",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.SetStoragePolicy:method.Actor",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.SetNetworkPolicy:method.Bind",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.SetStoragePolicy:method.Bind",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.SetNetworkPolicy:package.VerifiedOperationBinder",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.SetStoragePolicy:package.VerifiedOperationBinder",
		"internal/store/postgres/network_policy.go:DurableCoordinationService.SetNetworkPolicy:package.WithVerifiedOperation",
		"internal/store/postgres/storage_policy.go:DurableCoordinationService.SetStoragePolicy:package.WithVerifiedOperation",
