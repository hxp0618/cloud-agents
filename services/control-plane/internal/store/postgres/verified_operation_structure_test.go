...
func TestJWTUserDurableCoordinationVerifiedOperationCallGraphIsClosed(t *testing.T) {
	...
	requireCallerClosure(t, tree, "withFoundationOperation",
		...
		"*DurableCoordinationService.CreateSandboxUsageCorrection",
		"*DurableCoordinationService.CreateWorkspaceSnapshot",
	...
	requireCallerClosure(t, tree, "WithVerifiedOperation",
		...
		"*DurableCoordinationService.GetProjectLeaseQuota",
		"*DurableCoordinationService.GetNetworkPolicy",
		"*DurableCoordinationService.GetStoragePolicy",
		"*DurableCoordinationService.GetUserEnvironment",
		"*DurableCoordinationService.ListAdminDeniedWrites",
		"*DurableCoordinationService.ListAdminWorkers",
		"*DurableCoordinationService.ListOrganizations",
		"*DurableCoordinationService.ListProjectLeaseQuotaAuditEvents",
		"*DurableCoordinationService.ListNetworkPolicies",
		"*DurableCoordinationService.ListStoragePolicies",
		"*DurableCoordinationService.ListNetworkPolicyAuditEvents",
		"*DurableCoordinationService.ListStoragePolicyAuditEvents",
		...
		"*DurableCoordinationService.RegisterWorkerRelease",
		"*DurableCoordinationService.SetProjectLeaseQuota",
		"*DurableCoordinationService.SetNetworkPolicy",
		"*DurableCoordinationService.SetStoragePolicy",
