...
func TestRegisteredReceiptConsumersAreRecoveryOnly(t *testing.T) {
	...
	allowed := map[string]bool{"evidence_registered_receipt.go": true, "evidence_admission_history.go": true, "evidence_historical_supersession.go": true, "evidence_registered_generation_handoff.go": true, "evidence_generation_journal.go": true, "evidence_session.go": true}
