...
func TestAdmissionHistoryDigestSeparatesV2V3AndV4Profiles(t *testing.T) {
	t.Parallel()
	...
	v4 := *base
	v4.quotaProfile = LineageQuotaProfileV4
	v4.reservation = evidenceQuotaReservation{lineageQuotaProfile: LineageQuotaProfileV4, ReservedRecords: 1, ReservedJournalBytes: 2, ReservedSegments: 1, ReservedIndexRecords: 3, ReservedIndexBytes: 4, ReservedBytes: 6}
	v2Digest, v3Digest, v4Digest := admissionHistoryDigest(&v2), admissionHistoryDigest(&v3), admissionHistoryDigest(&v4)
	if v2Digest == ([32]byte{}) || v3Digest == ([32]byte{}) || v4Digest == ([32]byte{}) || v2Digest == v3Digest || v2Digest == v4Digest || v3Digest == v4Digest {
		t.Fatalf("admission history profile domains are not closed: v2=%x v3=%x v4=%x", v2Digest, v3Digest, v4Digest)
	}
}
