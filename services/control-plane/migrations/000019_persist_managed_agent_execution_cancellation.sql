CREATE FUNCTION cloud_agents.cancel_managed_agent_execution_v1(
    p_tenant_id text,
    p_project_uid text,
    p_session_uid text,
    p_turn_uid text,
...
BEGIN
    ...
    ELSE
        ...
        SET state = 'cancelled', result_digest = NULL, error_code = 'cancelled',
...
ALTER FUNCTION cloud_agents.cancel_managed_agent_execution_v1(text, text, text, text, text, bigint, text, text)
    OWNER TO cloud_agents_migration_owner;
REVOKE ALL ON FUNCTION cloud_agents.cancel_managed_agent_execution_v1(text, text, text, text, text, bigint, text, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION cloud_agents.cancel_managed_agent_execution_v1(text, text, text, text, text, bigint, text, text) TO cloud_agents_runtime;
