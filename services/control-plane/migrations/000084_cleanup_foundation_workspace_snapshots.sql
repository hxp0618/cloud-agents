...
('sha256:b1398bb866a44269a21a101f6e4d2b12eb19cbccd001b7f673010eecbf015f94', 'foundationWorkspaceSnapshot/v1alpha1', 'sha256:76432dc8e1962f28c4679c70fb4bcedc93171945ff816f625fb4c66aed3c177f', true),
('sha256:08450e3a84a4ede0ffc7c56d87cfbd1d52e44ebbb9c16a1d4042fdac0cf4bcb1', 'foundationWorkspaceSnapshotCleanup/v1alpha1', 'sha256:6157975f3a02c036472fca30bb309fcdee757c2cc99d04a0f053bb7cfd064f69', true)) AS profiles(registry, id, digest, creates_operation) WHERE registry = p_registry_digest AND id = p_profile_id AND digest = p_profile_digest) $$;
...
('sha256:9ebf663f49a5d1f5209d5c94656419d21fc2022105355d51a5b2fc3ed318378c', 'foundationSandboxLifecycle/v1alpha1', 'sha256:aabd6aa244c89a4850eba529dbe387132c3a0aff7ffba430f6115afb6e215a1b', true),
('sha256:b1398bb866a44269a21a101f6e4d2b12eb19cbccd001b7f673010eecbf015f94', 'foundationWorkspaceSnapshot/v1alpha1', 'sha256:76432dc8e1962f28c4679c70fb4bcedc93171945ff816f625fb4c66aed3c177f', true),
('sha256:08450e3a84a4ede0ffc7c56d87cfbd1d52e44ebbb9c16a1d4042fdac0cf4bcb1', 'foundationWorkspaceSnapshotCleanup/v1alpha1', 'sha256:6157975f3a02c036472fca30bb309fcdee757c2cc99d04a0f053bb7cfd064f69', true)) AS profiles(registry, id, digest, creates_operation) WHERE id = p_profile_id AND digest = p_profile_digest $$;
...
('sha256:9ebf663f49a5d1f5209d5c94656419d21fc2022105355d51a5b2fc3ed318378c', 'foundationSandboxLifecycle/v1alpha1', 'sha256:aabd6aa244c89a4850eba529dbe387132c3a0aff7ffba430f6115afb6e215a1b', true),
('sha256:b1398bb866a44269a21a101f6e4d2b12eb19cbccd001b7f673010eecbf015f94', 'foundationWorkspaceSnapshot/v1alpha1', 'sha256:76432dc8e1962f28c4679c70fb4bcedc93171945ff816f625fb4c66aed3c177f', true),
('sha256:08450e3a84a4ede0ffc7c56d87cfbd1d52e44ebbb9c16a1d4042fdac0cf4bcb1', 'foundationWorkspaceSnapshotCleanup/v1alpha1', 'sha256:6157975f3a02c036472fca30bb309fcdee757c2cc99d04a0f053bb7cfd064f69', true)) AS profiles(registry, id, digest, creates_operation) WHERE id = p_profile_id AND digest = p_profile_digest AND creates_operation) $$;
...
BEGIN
    ...
    WHERE record.tenant_id = tenant AND record.subject_digest = p_subject
      AND record.profile_id = 'foundationWorkspaceSnapshotCleanup/v1alpha1' AND record.profile_digest = 'sha256:6157975f3a02c036472fca30bb309fcdee757c2cc99d04a0f053bb7cfd064f69'
    ...
    VALUES (tenant, tenant, p_subject, 'sha256:08450e3a84a4ede0ffc7c56d87cfbd1d52e44ebbb9c16a1d4042fdac0cf4bcb1', 'foundationWorkspaceSnapshotCleanup/v1alpha1', 'sha256:6157975f3a02c036472fca30bb309fcdee757c2cc99d04a0f053bb7cfd064f69',
    ...
    VALUES (tenant, tenant, operation_value, 1, 'sha256:08450e3a84a4ede0ffc7c56d87cfbd1d52e44ebbb9c16a1d4042fdac0cf4bcb1', cloud_agents.coordination_state_machine_digest(),
        cloud_agents.coordination_policy_digest(), 'foundationWorkspaceSnapshotCleanup/v1alpha1', 'sha256:6157975f3a02c036472fca30bb309fcdee757c2cc99d04a0f053bb7cfd064f69', p_subject, p_digest,
        'pending', 'none', 0, 0);
    ...
    VALUES (tenant, tenant, event_value, 'sha256:08450e3a84a4ede0ffc7c56d87cfbd1d52e44ebbb9c16a1d4042fdac0cf4bcb1', 'foundationWorkspaceSnapshotCleanup/v1alpha1', 'sha256:6157975f3a02c036472fca30bb309fcdee757c2cc99d04a0f053bb7cfd064f69', 'operation_effect',
    ...
    VALUES (tenant, tenant, audit_value, 'sha256:08450e3a84a4ede0ffc7c56d87cfbd1d52e44ebbb9c16a1d4042fdac0cf4bcb1', 'foundationWorkspaceSnapshotCleanup/v1alpha1', 'sha256:6157975f3a02c036472fca30bb309fcdee757c2cc99d04a0f053bb7cfd064f69',
    ...
    WHERE tenant_id = tenant AND subject_digest = p_subject AND profile_id = 'foundationWorkspaceSnapshotCleanup/v1alpha1'
      AND profile_digest = 'sha256:6157975f3a02c036472fca30bb309fcdee757c2cc99d04a0f053bb7cfd064f69' AND idempotency_key = p_key;
    RETURN operation_value;
END;
$$;
...
BEGIN
    ...
    WHERE event.tenant_id = p_tenant AND event.event_id = p_event AND event.state = 'claimed'
      AND event.profile_id = 'foundationWorkspaceSnapshotCleanup/v1alpha1' AND event.profile_digest = 'sha256:6157975f3a02c036472fca30bb309fcdee757c2cc99d04a0f053bb7cfd064f69'
...
BEGIN
    ...
    IF NOT FOUND OR event.state <> 'claimed' OR event.profile_id <> 'foundationWorkspaceSnapshotCleanup/v1alpha1'
      OR event.profile_digest <> 'sha256:6157975f3a02c036472fca30bb309fcdee757c2cc99d04a0f053bb7cfd064f69' OR event.claim_holder_id IS DISTINCT FROM p_holder
