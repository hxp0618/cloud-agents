CREATE FUNCTION cloud_agents.transition_foundation_sandbox_v4(
    ...
    IF operation_value IS NULL THEN
        ...
        ELSE
            ...
            WHERE profile.tenant_id = sandbox.tenant_id AND profile.project_uid = sandbox.project_uid
                ...
                AND (target.target_kind = 'docker' OR target.target_kind = 'remote-worker'
...
CREATE FUNCTION cloud_agents.settle_remote_worker_foundation_sandbox_v3(
...
BEGIN
    ...
    IF p_tenant IS DISTINCT FROM cloud_agents.require_tenant_id()
        ...
        OR p_attempt NOT BETWEEN 1 AND 8 OR p_action NOT IN ('sandbox.create', 'sandbox.stop', 'sandbox.rebuild')
        ...
        OR p_transition = 'succeeded' AND (
            ...
            OR p_action IN ('sandbox.create', 'sandbox.rebuild') AND (
    ...
    WHERE attempt.tenant_id = p_tenant AND sandbox.project_uid = p_project
      ...
      AND (p_transition = 'succeeded' AND attempt.state = 'succeeded'
           AND (p_action IN ('sandbox.create', 'sandbox.rebuild') AND sandbox.observed_state = 'running'
...
CREATE FUNCTION cloud_agents.claim_foundation_sandbox_v7(
...
ALTER FUNCTION cloud_agents.claim_foundation_sandbox_v7(text,text,text,text,text,integer,text,text) OWNER TO cloud_agents_migration_owner;
ALTER FUNCTION cloud_agents.settle_remote_worker_foundation_sandbox_v3(text,text,text,text,text,bigint,text,text,text,bigint,text,text,text,text,text,boolean,text,text) OWNER TO cloud_agents_migration_owner;
...
REVOKE ALL ON FUNCTION cloud_agents.claim_foundation_sandbox_v7(text,text,text,text,text,integer,text,text) FROM PUBLIC;
REVOKE ALL ON FUNCTION cloud_agents.settle_remote_worker_foundation_sandbox_v3(text,text,text,text,text,bigint,text,text,text,bigint,text,text,text,text,text,boolean,text,text) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION cloud_agents.transition_foundation_sandbox_v3(text,text,bigint,bigint,text,text,text,text,text,text,text,text) FROM cloud_agents_runtime;
REVOKE EXECUTE ON FUNCTION cloud_agents.claim_foundation_sandbox_v6(text,text,text,text,text,integer,text,text) FROM cloud_agents_runtime;
REVOKE EXECUTE ON FUNCTION cloud_agents.settle_remote_worker_foundation_sandbox_v2(text,text,text,text,text,bigint,text,text,text,bigint,text,text,text,text,text,boolean,text,text) FROM cloud_agents_runtime;
...
GRANT EXECUTE ON FUNCTION cloud_agents.claim_foundation_sandbox_v7(text,text,text,text,text,integer,text,text) TO cloud_agents_runtime;
GRANT EXECUTE ON FUNCTION cloud_agents.settle_remote_worker_foundation_sandbox_v3(text,text,text,text,text,bigint,text,text,text,bigint,text,text,text,text,text,boolean,text,text) TO cloud_agents_runtime;
