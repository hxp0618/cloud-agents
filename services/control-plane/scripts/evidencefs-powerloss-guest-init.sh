...
case "$mode" in
  create-object | verify-object | create-generation | verify-all | crash-object | classify-object | crash-generation-append | classify-generation-append) ;;
  *)
...
if [ "$mode" = create-object ] || [ "$mode" = crash-object ] || [ "$mode" = crash-generation-append ]; then
