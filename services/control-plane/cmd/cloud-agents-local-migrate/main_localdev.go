...
func main() {
	...
	flag.StringVar(&manifestSelector, "selector", "", "migration selector (canonical-000013, successor-000014, product-000015, product-000016, product-000017, or product-000018)")
	flag.Parse()
