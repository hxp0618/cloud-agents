...
func main() {
	...
	flag.StringVar(&manifestSelector, "selector", "", "migration selector (canonical-000013, successor-000014, product-000015, product-000016, product-000017, product-000018, product-000019, or product-000020)")
	flag.Parse()
