...
| ------------------ | ---------------------------- | ----------- | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| G-BASELINE-P0      | Platform Architecture DRI    | P0          | verified    | `CAG-G-BASELINE-P0-20260810-R3`：将 R2 的固定 ref legacy Synara/T3 characterization 与 greenfield Managed Host spec/negative/reference-host baseline 原样重绑定到 Inventory R3；真实 Provider 未执行 |
