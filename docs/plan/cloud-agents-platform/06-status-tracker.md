...
- Implementation status：P0 VERIFIED；P1 IN PROGRESS（P1-A1 bootstrap complete / P1-A2.1 core implementation）；M1/P2–P6 PAUSED
...
| P1 Foundation     | IN PROGRESS | hxp0618 / Codex executor    | P0 verified                           | G-CONTRACT/G-DATA/G-AUTHORITY-P1/G-SECURITY-P1                                                  | [ADR-0007](../adr/0007-p1-contract-data-toolchain-foundation.md)；[ADR-0008](../adr/0008-p1-postgres-data-kernel.md)；[ADR-0009](../adr/0009-p1-migration-bundle-runner.md)；[P1 execution](../p1/README.md) |
...
| G-DATA              | none                           | IN PROGRESS | `ADR-0007 / ADR-0008 / ADR-0009 / G-INVENTORY R3 / G-BASELINE-P0 R3`  | SQL/bootstrap、bundle/runner core、tenant helper matrix complete；projector/trust/recovery/closure open   | 2026-08-11    |
| G-AUTHORITY-P1      | none                           | IN PROGRESS | `ADR-0007 / ADR-0008 / ADR-0009 / G-INVENTORY R3 / G-BASELINE-P0 R3`  | Public wire/module/SQL/migration authority core implemented；runtime projector/identity closure open      | 2026-08-11    |
...
| G-SECURITY-P1       | none                           | IN PROGRESS | `ADR-0007 / ADR-0008 / ADR-0009 / G-INVENTORY R3 / G-BASELINE-P0 R3`  | Fail-closed fixtures + RLS/role/bootstrap + tenant helper PG15–17 matrix；projector/identity/closure open | 2026-08-11    |
