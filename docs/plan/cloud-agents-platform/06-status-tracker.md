...
- 下一项：继续 BASE-M4，实现多 Node 的 owner/region/runtime/arch/卷可达性确定性选择，再补强隔离矩阵。
...
| BASE-M4    | IN PROGRESS | direct Kubernetes、RemoteWorker 能力矩阵及单 Pool 聚合容量已实测；仍需多 Node 确定性选择、强隔离矩阵/限制界面 |
