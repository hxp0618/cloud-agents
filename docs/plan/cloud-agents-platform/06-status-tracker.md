...
| G-SECURITY-P1       | none                           | IN PROGRESS | `ADR-0007 / ADR-0008 / ADR-0009 / ADR-0010 / G-INVENTORY R3 / G-BASELINE-P0 R3` | Fail-closed adapters + retained append/checkpoint/rotation/repair/reconcile fault gates through pushed `93d3263` complete；真实 mount/cross-process/power-loss、public session 与 closure open                      | 2026-08-14    |
...
| G-SUPPLY-CHAIN      | none                           | IN PROGRESS | `99106e8 / 93f742f`                                                             | [pgx/x-text dependency implementation closure](../p1/dependency-reviews/pgx-v5.10.0-x-text-v0.39.0-implemented-closure.md)；source-bound refresh、final binary/artifact same-bits scan与immutable Gate closure open | 2026-08-11    |
...
- [x] ADR-0010 冻结 PostgreSQL signed expected projection、deployment authority binding、snapshot 与
      P1-A2.1a/P1-A2.1b 顺序；A2.1a-impl-1/2 已由 `b36f45a`、`e2541c5`、`a0eac37` 完成，当前只进入
      A2.1a-impl-3 runner wiring。
