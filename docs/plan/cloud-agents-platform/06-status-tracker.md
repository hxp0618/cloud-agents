...
- 下一项：继续 BASE-M4，补 RemoteWorker runtime/arch/storage/network capability admission 的最小真实矩阵及对应 Admin 状态，再进入 Region/Pool/Node/capacity placement。
...
| BASE-M4    | IN PROGRESS | direct Kubernetes Foundation 已实测；仍需客户节点能力/容量/强隔离矩阵及 Region/Pool/Node placement/限制界面 |
