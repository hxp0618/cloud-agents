...
| ----------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| `runner-ledger-recovery-admission/v1`           | `3b9f4e4e285b79d7611351f0f94378660a6d5283e6a541607e68e29b3a6d6dc3` | `sha256:593c0199a8f4e59a6b29cb0b9f49894eef2911cb9fe9bf69b70eb15ef79d658a` | `sha256:b92e6352d7bbfa0e607bcde06a7c4fe7e508adc6b954c9a048584da571014869` |
| `runner-ledger-abort-terminal-writer/v1`        | `e8e0629b2ca8536abe88bcb31095831484bc18dc58d7f31633a46ac0630aafe2` | `sha256:0ab975d0e07b5bc089304189430fadd94d67ba2ca818f5dba934e6acf2db9a9c` | `sha256:51ed8da74a752291adda6ba3de8be9e864d7165b83a8279c1c02e02987a7413d` |
| `runner-ledger-commit-observation-writer/v1`    | `92e179eb16441fd98a3ac581c748c49556810d97fb82bda435896a5ef911fb99` | `sha256:f7c5d1e357a7cd5cbc1d93d06cb8a82114cc5a401a3b95ddaa468d0e173cf8e0` | `sha256:4c741b8aebc58245230d2f704393c5f563a416db05c9ac49126834377596dc31` |
| `runner-ledger-ambiguous-resolution-writer/v1`  | `a497b1e1c8ef3da8a7eef447158f9a06191c09be77e40679a4a3f2edd8da9506` | `sha256:9220c0bcd9936f2ab4eb7a7f81f02f065823dc1450bf0ea330e574ac96da137c` | `sha256:2bdfc33ba4afcdbaac5d93bf5d087a604bfe7bdc05a41fd027d221eff50df691` |
...
| `runner-ledger-return-failure/v1`               | `cadcbf9e8b31e18ad56d6b4d5d00f839da0c035fd01a1fbbd02f23805097f97d` | `sha256:bd6bd2b5c0534a25a1fa6c1f76808a6691154ae7bcf795298bfd6ed0c6b07f13` | `sha256:b7b80f60b702bc64c5e1c5e26771f00db5687c0ff96c721cccdc088de587d4fe` |
...
`contracts/generation.lock.json` has SHA-256 `bd56b9342d2ce9082ad3a3611ecae2a65542cc29922e847b001f6ce12d9cfdf4`
and adds two `notGateClosure: true` pipelines:

| Pipeline                                             | Input manifest SHA-256                                                    | Outputs                                   |
| ---------------------------------------------------- | ------------------------------------------------------------------------- | ----------------------------------------- |
| `runner-ledger-recovery-registry-suite-generation`   | `sha256:fb46fce6d84efed07fabf51af7c9e7a2bff7f1a7c08f160e4dd97646f3541523` | eight generated registries above          |
| `runner-ledger-recovery-go-profile-suite-generation` | `sha256:bd31d9eaf3addab12dc3ffa97f7408c415da7628fd7ab2ba38c6fe88f3f85bc4` | `sha256:84895679...c3b` ordinary Go facts |
...
- recovery registry focused test: `5/5` PASS with `78` assertions;
...
- target formatting, repository lint, Markdown links, and `git diff --check`: PASS;
- staged candidate Gitleaks `8.30.1`: PASS over approximately `260.65 KB`, no leaks found; and
