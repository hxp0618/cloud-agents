...
- Fixed implementation：`de36ca343cb2790c8ba44186807d6c933bd98500`
- Fixed repository tree：`03c93f024de599fdb8a3178b38b18359070af925`
- Fixed `services/control-plane` subtree：`88db04ed5d6fde8895805819ad41fbd267b64868`
...
5. fail-closed connection handling: callback failure rolls back, commit ambiguity discards the connection and
   returns `ErrMutationCommitUnknown`, while a cleanup failure after confirmed commit discards the connection
   without returning a retry-inviting mutation failure;
...
| Go mutation service                           | `e339215308f1d9acea7c35adb809c3a89c6d3a1852970571b0a3e34dc365b436` |
| Go mutation unit tests                        | `8f2eaa0351b24619132e5832f4dcb6bd16c4cd91dca46f4f1907d18783db48b0` |
...
| source-bound dependency lock                  | `e463522a3313fe8bd2594cf18f6ebd6d90a8d7220071ee737fdb133813a1d178` |
| CycloneDX 1.6 SBOM                            | `1e1197a401bfff1879fe241a0e358346ce5f4d274e4af340f9a39f6e2af2f8c0` |
...
PASS on the fixed implementation bytes:
...
| ------------------------------------------- | ------------------------------------------------------------------ |
| Source commit                               | `de36ca343cb2790c8ba44186807d6c933bd98500`                         |
| Repository tree OID                         | `03c93f024de599fdb8a3178b38b18359070af925`                         |
| `services/control-plane` subtree OID        | `88db04ed5d6fde8895805819ad41fbd267b64868`                         |
| 335-file tracked manifest SHA-256           | `d8fb4a46d2e6a28785cad1f59929e073d5b5bb72fa6c76525dba61a77370d9b3` |
| 258-file tracked Go-source manifest SHA-256 | `0b210ad21b500b45a6bbfb51e33263f1686c92bb4eb4f153fcba4fb4ab7563fe` |
...
Fresh `govulncheck v1.6.0` module and Linux/amd64 symbol scans used exact Go `1.26.6` and database timestamp
