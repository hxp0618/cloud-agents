...
- [`p1-aggregate-gate-gap-audit-20260822.md`](p1-aggregate-gate-gap-audit-20260822.md)：
  ...
  current acceptance prerequisite；历史审计仍保持 byte/history 边界
...
brand-new/registered activation-handoff；runner/DB `Connect`、current-source immutable phase records、remaining
durability matrices 与 independent Gate reviews 仍然开放。ADR-0024 不再要求 physical controller power-loss，且不声称
已经取得该物理结果。
